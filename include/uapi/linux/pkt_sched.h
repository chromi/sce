...
enum {
	...
	TCA_DELTIC_FREQ_SIGNAL,
	TCA_DELTIC_FREQ_DROP,
	TCA_DELTIC_FREQ_ECN,
	TCA_DELTIC_FREQ_SCE,

	TCA_DELTIC_ACK_FILTER,	/* CAKE_ACK_* */
	TCA_DELTIC_SPLIT_GSO,

	TCA_DELTIC_FLOW_MODE,	/* CAKE_FLOW_* */
	TCA_DELTIC_NAT,
	TCA_DELTIC_FWMARK,
	TCA_DELTIC_FWMARK_STORE,

	TCA_DELTIC_BASE_RATE64,
	TCA_DELTIC_INGRESS,
	TCA_DELTIC_AUTORATE,
	TCA_DELTIC_OVERHEAD,
	TCA_DELTIC_RAW,
	TCA_DELTIC_ATM,	/* CAKE_ATM_* */
	TCA_DELTIC_MPU,

	TCA_DELTIC_DIFFSERV_MODE,	/* CAKE_DIFFSERV_* */
	TCA_DELTIC_WASH,

	__TCA_DELTIC_MAX
};
#define TCA_DELTIC_MAX	(__TCA_DELTIC_MAX - 1)

enum {
	__TCA_DELTIC_STATS_INVALID,
	TCA_DELTIC_STATS_PAD,

	TCA_DELTIC_STATS_JITTER_EST,
	TCA_DELTIC_STATS_SCE_MARKS,
	TCA_DELTIC_STATS_CE_MARKS,
	TCA_DELTIC_STATS_AQM_DROPS,

	__TCA_DELTIC_STATS_MAX
};
#define TCA_DELTIC_STATS_MAX (__TCA_DELTIC_STATS_MAX - 1)
